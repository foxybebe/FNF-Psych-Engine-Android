...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['bruh vc e muito ruim', 0.2], //From 0% to 19%
		['lixo', 0.4], //From 20% to 39%
		['melhor do que lixo', 0.5], //From 40% to 49%
		['Mds', 0.6], //From 50% to 59%
		['humm', 0.69], //From 60% to 68%
		['meh', 0.7], //69%
		['otimo', 0.8], //From 70% to 79%
		['caraca', 0.9], //From 80% to 89%
		['MANEIRO!', 1], //From 90% to 99%
		['CARALHO MAEEEEEEEE!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingName == '?') {
			scoreTxt.text = 'Ponto: ' + songScore + ' | Erros: ' + songMisses + ' | Precisao: ' + ratingName;
		} else {
			scoreTxt.text = 'Ponto: ' + songScore + ' | Erros: ' + songM
        }
	...
	public function getControl(key:String) {
		var pressed:Bool = Reflect.getProperty(controlakey);
